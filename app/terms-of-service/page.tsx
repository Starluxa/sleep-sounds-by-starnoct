...
export default function TermsOfServicePage() {
  ...
  const { document, loading, error, refresh } = useLegalDocument('terms-of-service')
        ...
        <div className="bg-slate-900/40 backdrop-blur-md border border-slate-700 rounded-xl p-8 shadow-2xl min-h-[400px] flex flex-col">
          {loading ? (
            <div className="flex-1 flex flex-col items-center justify-center gap-4">
              ...
              <p className="text-slate-400 animate-pulse">Loading Terms of Service...</p>
            </div>
          ) : error ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center p-6">
              ...
              <p className="text-slate-400 max-w-md mb-6">
                {error instanceof TamperDetectedError
                  ...
                  : "We encountered an issue while trying to load the terms of service. Please try again later."}
              </p>
